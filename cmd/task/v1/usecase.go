...
type TaskUsecase interface {
	GetManyTasks(ctx context.Context) (resp response.Response)
...
func (u *taskUsecase) GetManyTasks(ctx context.Context) (resp response.Response) {
	result, err := u.taskRepository.FindMany(ctx)
	if err != nil {
